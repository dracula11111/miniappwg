(() => {
  ...
  const PAGE_ID = 'comboPage';
  const STORAGE_KEY = 'wt_combo_endless_v2';
  const SIZE = 8;
  const WILDCOIN_ICON = '/icons/currency/wildcoin.svg';
  const BG_PRIMARY = '/images/combo/backgrounds/background-9x16.webp';
  const BG_FALLBACK = '/images/combo/backgrounds/background-9x16-fallback.svg';

  const TILE_TYPES = [
    {
      id: '01',
      src: '/images/combo/items/item-01.png',
      fallback: '/images/combo/items/item-01-fallback.svg'
    },
    {
      id: '02',
      src: '/images/combo/items/item-02.png',
      fallback: '/images/combo/items/item-02-fallback.svg'
    },
    {
      id: '03',
      src: '/images/combo/items/item-03.png',
      fallback: '/images/combo/items/item-03-fallback.svg'
    },
    {
      id: '04',
      src: '/images/combo/items/item-04.png',
      fallback: '/images/combo/items/item-04-fallback.svg'
    },
    {
      id: '05',
      src: '/images/combo/items/item-05.png',
      fallback: '/images/combo/items/item-05-fallback.svg'
    },
    {
      id: '06',
      src: '/images/combo/items/item-06.png',
      fallback: '/images/combo/items/item-06-fallback.svg'
    },
    {
      id: '07',
      src: '/images/combo/items/item-07.png',
      fallback: '/images/combo/items/item-07-fallback.svg'
    },
    {
      id: '08',
      src: '/images/combo/items/item-08.png',
      fallback: '/images/combo/items/item-08-fallback.svg'
    }
  ];
  ...
  function emitWildCoin() {
    try {
      window.dispatchEvent(new CustomEvent('combo:wildcoin-update', {
  ...
  function renderBoard() {
    ...
    for (let r = 0; r < SIZE; r += 1) {
      for (let c = 0; c < SIZE; c += 1) {
        ...
        img.alt = '';
        img.draggable = false;
        img.src = tile?.renderSrc || tile?.fallback || '/images/combo/items/item-01-fallback.svg';
  ...
  function ensurePage() {
    ...
    node.innerHTML = `
      <section class="combo-root" aria-label="Combo">
        ...
        <div class="combo-board-wrap" id="comboBoardWrap">
          <div class="combo-board" id="comboBoard" role="grid" aria-label="Combo board"></div>
        </div>
  ...
  function exposeApi() {
    window.WTCombo = {
      ...
      openEconomySheet: () => {
        openModal(
          'WildCoin',
          `Balance: ${Math.max(0, Math.round(state.wildCoin || 0))}. Earn more by matching tiles in Combo.`,
          [
            {
              label: 'Close',
              kind: 'primary',
