...
ALTER TABLE public.daily_case_openings ENABLE ROW LEVEL SECURITY;
ALTER TABLE public.market_items ENABLE ROW LEVEL SECURITY;
ALTER TABLE public.gift_readable ENABLE ROW LEVEL SECURITY;
...
REVOKE ALL ON TABLE public.daily_case_openings FROM anon, authenticated;
REVOKE ALL ON TABLE public.market_items FROM anon, authenticated;
REVOKE ALL ON TABLE public.gift_readable FROM anon, authenticated;
...
DROP POLICY IF EXISTS service_role_full_access ON public.daily_case_openings;
DROP POLICY IF EXISTS service_role_full_access ON public.market_items;
DROP POLICY IF EXISTS service_role_full_access ON public.gift_readable;
...
CREATE POLICY service_role_full_access ON public.daily_case_openings FOR ALL TO service_role USING (true) WITH CHECK (true);
CREATE POLICY service_role_full_access ON public.market_items FOR ALL TO service_role USING (true) WITH CHECK (true);
CREATE POLICY service_role_full_access ON public.gift_readable FOR ALL TO service_role USING (true) WITH CHECK (true);
